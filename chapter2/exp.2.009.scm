...
(display (width (add-interval interval-a interval-b)))
(newline)
(display "sub-interval")
(display (width (sub-interval interval-a interval-b)))
(newline)
(display "mul-interval")
(display (width (mul-interval interval-a interval-b)))
(newline)
(display "div-interval")
(display (width (div-interval interval-a interval-b)))
